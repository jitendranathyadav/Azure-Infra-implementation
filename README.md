...
<img align="right" width="400" height="400" alt="image" src="https://github.com/user-attachments/assets/67cbf163-1f6e-41fc-b778-4faabe1bd1c3" >

**Professional Profile**

**About Me**

I am a seasoned Cloud Infrastructure and DevSecOps professional with over 19 years of experiance in the IT industry. With a strong foundation in Azure DevSecOps and over 10 years of dedicated cloud experience, and 9 years of experiance in on-prem virtualization with VmWare and Citrix products for delivering end-to-end SaaS product. I have delivered numerous successful projects ranging from On-prem to Azure cloud migrations. On-boaring to teh Cloud with WAF, CAF and Landing zones framework.
...
- 🛠️ **Tool Proficiency**: Skilled in utilizing a wide range of DevOps and security tools, including but not limited to Azure DevOps, Docker, Kubernetes, Terraform, Ansible, and various security 
                            scanning tools.
...
## Experience Overview
- **Overall Experience**: 19+ years
- **Azure DevSecOps**: 5+ years
- **Cloud Experience**: 10+ years
- **On-Prem Virtulization**: 15+ years
- **On-prem to Azure Cloud Migration**: Multiple successful projects
- **Landing Zones Implementation**: Lead and architected the successful implementation
- **Cloud Infrastructure Logging**: Orchestrated successfull logging into Log Analytics Workspace and SIAM based on the purpose
